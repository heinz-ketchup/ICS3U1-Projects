# Author: Gavin Xiong
# Date: 2022/05/19
# Purpose: Date class with overloaded operators
...
# Author: Gavin Xiong
# Date: 2022/05/19
# Purpose: Provide date class with overloaded operators.
# ____________________________________________________________________
# DATA ELEMENTS
...
class Date:
    ...
    # Author: Gavin Xiong
    # Date: 2022/05/19
    # Purpose: __gt__ function
    # Parameters: secondDate
    # Output: result
    def __gt__(self, secondDate):
        result = False
        if self.intYear > secondDate.intYear:
            result = True
        elif self.intYear < secondDate.intYear:
            result = False
        elif self.dayOfYear() > secondDate.dayOfYear():
            result = True
        return result

    # Author: Gavin Xiong
    # Date: 2022/05/19
    # Purpose: __lt__ function
    # Parameters: secondDate
    # Output: result
    ...
    # Author: Gavin Xiong
    # Date: 2022/05/19
    # Purpose: __eq__ function
    # Parameters: secondDate
    # Output: result
    def __eq__(self, secondDate):
        result = False
        if self.intYear == secondDate.intYear:
            if self.dayOfYear() == secondDate.dayOfYear():
                result = True
        else:
            result = False
        return result
    ...
    # Author: Gavin Xiong
    # Date: 2022/05/19
    # Purpose: __ne__ function
    # Parameters: secondDate
    # Output: result
    def __ne__(self, secondDate):
        return not self.__eq__(secondDate)

    # Author: Gavin Xiong
    # Date: 2022/05/19
    # Purpose: __sub__ function
    # Parameters: secondDate
    # Output: result
    def __sub__(self, secondDate):
        ...
        if self.intYear == secondDate.intYear:
            dayCount = abs(self.dayOfYear() - secondDate.dayOfYear())
        else:
            currentYear = self.intYear
            for year in range(secondDate.intYear - self.intYear+1):
                if year == 0:
                    if self.returnLeapYear():
                        dayCount += 366 - self.dayOfYear() + 1
                    else:
                        dayCount += 365 - self.dayOfYear() + 1
                elif year == secondDate.intYear - self.intYear:
                    dayCount += secondDate.dayOfYear()
                else:
                    tempDate = Date(intYear = currentYear)
...
# MAIN
userDate1 = Date().getDate()
userDate2 = Date().getDate()

for i in range(20):
    print()

print(f"Date 1: {userDate1}")
print(f"Date 2: {userDate2}")
print(f"{userDate1} > {userDate2} = {userDate1 > userDate2}")
print(f"{userDate1} < {userDate2} = {userDate1 < userDate2}")
print(f"{userDate1} >= {userDate2} = {userDate1 >= userDate2}")
print(f"{userDate1} <= {userDate2} = {userDate1 <= userDate2}")
print(f"{userDate1} == {userDate2} = {userDate1 == userDate2}")
